...
public class IslandMemberDemoteEvent extends Event {
	...
	public IslandMemberDemoteEvent(Island island, Member member, Role role, Role old, Member by) {
		this.island = island;
		this.member = member;
		this.role = role;
		this.old = old;
	...
	public Member getDemotedBy() { return this.by; }
}
